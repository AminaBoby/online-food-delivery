                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="d_name" class="form-control" placeholder="Dish Name">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" class="form-control form-control-danger" placeholder="about">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
