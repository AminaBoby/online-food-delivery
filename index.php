        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"><b> Foodies</b></a>
...
<div class="image">
   <img src="food_images/about-img.png" alt="">
</div>

<div class="content">
   <h3 class="title">Welcome to our Restaurant </h3>
   <p>People say you cannot buy happiness with money but I say that you can buy some good food with money and that is pretty much the same.</p>
   <p>One Click, one order and you get the food delivered.</p>
   <a href="#" class="btn">Read more</a>
   <div class="icons-container">
      <div class="icons">
         <img src="food_images/about-icon-1.png" alt="">
         <h3>quality food</h3>
      </div>
      <div class="icons">
         <img src="food_images/about-icon-2.png" alt="">
         <h3>food & drinks</h3>
      </div>
      <div class="icons">
         <img src="food_images/about-icon-3.png" alt="">
         <h3>expert chefs</h3>
      </div>
   </div>
</div>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> TK 200</div>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> Foodies<br/> </a> <span>Order Delivery &amp; Take-Out </span> </div>
